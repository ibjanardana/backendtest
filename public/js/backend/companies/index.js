$(function () {
    ...
    var formatActionField = function (row, cell, formatterParams) {
        return '<form id="form-delete-' + row.getData()['id'] + '" action="' + rootUrl + '/admin/companies/delete/" method="get">' +
               '<a class="btn btn-primary" href="' + rootUrl + '/admin/companies/edit/' + row.getData()['id'] + '" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;' +
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            ...
            {title: "Prefecture ID", field: "prefecture_id", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
